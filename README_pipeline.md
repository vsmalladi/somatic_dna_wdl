...
- SNV/INDEL/SV/CNV calls and figures from individual callers
...
- Final MSI Status
  - TUMOR--NORMAL.mantis.WGS-targeted.status.final.tsv
...
autocorrelation metric (adapted for WGS from ([4](#4))) to check for unevenness of coverage. We also
run Conpair ([5](#5)), a tool developed at NYGC to check the genetic concordance between the
normal and the tumor sample and to estimate any inter-individual contamination in the samples. Tumor samples 
that do not have a matched normal sample are checked for contamination using the GATK tool CalculateContamination
in the tumor-only mode.
...
merged across callers using bedtools ([14](#14)) pairtopair (slop of 300bp, same strand orientation,
...
step, requiring that the breakpoints being compared were within 300bp of each other, with the same strand orientation. 
For the first merge, caller-PASS calls were merged at the sample level, resulting in 3202 VCFs. There are a number of 
related samples within the updated 1000G cohort, so an additional merge step was performed that merged VCFs from related 
individuals at the family level to avoid overestimating variant prevalence. This step resulted in 1976 VCFs. Finally, 
the single-sample or merged-family results were merged together, resulting in a single VCF. The resultant VCF was converted 
to BEDPE, and filtered for variants greater than 500bp on autosomes and allosomes, appearing in more than one sample or family. 
...
(MAF) of 1% or higher in either 1000Genomes (phase 3) or gnomAD (r2.0.2) ([19](#19)), and SVs that
...
#### SNVs and Indels
Somatic and germline SNVs/Indels are annotated with Ensembl Variant Effect Predictor (v97) ([20](#20)) as well as databases such as COSMIC (v92)
([21](#21)), 1000Genomes (Phase3) ([22](#22)) , ClinVar (201904) ([23](#23)), Polyphen2 (v2.2.2) ([24](#24)), SIFT (v5.2.2) 
([25](#25)), FATHMM (v2.1) ([26](#26)), gnomAD (r2.0.2) and dbSNP (v150) ([27](#27)) using Variant Effect Predictor.
...
Genomic Variants (DGV) ([15](#15)). Cancer-specific annotation includes overlap with genes from
Ensembl ([16](#16)) and Cancer Gene Census in COSMIC, and potential effect on gene structure (e.g.
...
We run MANTIS (v1.0.4) ([28](#28)) for Microsatellite Instability (MSI) detection in microsatellite loci
...
We run Kourami (v0.9.6) ([29](#29)) on the matched normal sample for
...
We run deconstructSigs (v1.9.0) ([30](#30)) on the High Confidence somatic SNV callset within
autosomes to estimate contribution of known [COSMIC mutational signatures (v3)](https://cancer.sanger.ac.uk/signatures/)
in the tumor sample.
...
<a name="4"></a>
4. Zhang,L. and Zhang,L. (2013) Use of autocorrelation scanning in DNA copy number analysis.
Bioinformatics, 29, 2678–2682
<a name="5"></a>
5. Bergmann,E.A., Chen,B.-J., Arora,K., Vacic,V. and Zody,M.C. (2016) Conpair: concordance
and contamination estimator for matched tumor-normal pairs. Bioinformatics, 32,
3196–3198.
<a name="6"></a>
6. Cibulskis,K., Lawrence,M.S., Carter,S.L., Sivachenko,A., Jaffe,D., Sougnez,C., Gabriel,S.,
...
<a name="7"></a>
7. Kim,S., Scheffler,K., Halpern,A.L., Bekritsky,M.A., Noh,E., Källberg,M., Chen,X., Kim,Y.,
Beyter,D., Krusche,P., et al. (2018) Strelka2: fast and accurate calling of germline and
somatic variants. Nat. Methods, 15, 591–594.
<a name="8"></a>
8. Narzisi,G., Corvelo,A., Arora,K., Bergmann,E.A., Shah,M., Musunuri,R., Emde,A.-K.,
...
<a name="9"></a>
9. Wala,J.A., Bandopadhayay,P., Greenwald,N.F., O’Rourke,R., Sharpe,T., Stewart,C.,
...
<a name="10"></a>
10. Chen,X., Schulz-Trieglaff,O., Shaw,R., Barnes,B., Schlesinger,F., Källberg,M., Cox,A.J.,
...
<a name="11"></a>
11. Cameron,D.L., Schröder,J., Penington,J.S., Do,H., Molania,R., Dobrovic,A., Speed,T.P., Papenfuss,A.T. (2017)
GRIDSS: sensitive and specific genomic rearrangement detection using positional de Bruijn graph assembly. 
Genome Research, 27(12):2050-2060.
<a name="12"></a>
12. Cameron,D.L., Baber,J., Shale,C., Valle-Inclan,J.E., Besselink,N., van Hoeck,A., Janssen.R.,
Cuppen,E., Priestley,P., Papenfuss,A.T. (2021) GRIDSS2: comprehensive characterisation of somatic structural
variation using single breakend variants and structural variant phasing. Genome Biol., 12;22(1):202.
<a name="13"></a>
13. Xi,R., Lee,S., Xia,Y., Kim,T.-M. and Park,P.J. (2016) Copy number analysis of
...
<a name="14"></a>
14. Quinlan,A.R. and Hall,I.M. (2010) BEDTools: a flexible suite of utilities for comparing
genomic features. Bioinformatics, 26, 841–842.
<a name="15"></a>
15. MacDonald,J.R., Ziman,R., Yuen,R.K.C., Feuk,L. and Scherer,S.W. (2014) The Database of
Genomic Variants: a curated collection of structural variation in the human genome. Nucleic
Acids Res., 42, D986–92.
<a name="16"></a>
16. Hubbard,T. (2002) The Ensembl genome database project. Nucleic Acids Research, 30,
38–41.
<a name="17"></a>
17. Byrska-Bishop,M., Evani,U.S., Zhao,X., Basile,A.O., Abel,H.J., Regier,A.A., Corvelo,A., Clarke,W.E., 
Musunuri,R., Nagulapalli,K., Fairley.S., Runnels,A., Winterkorn,L., Lowy-Gallego,E. (2021) High coverage 
whole genome sequencing of the expanded 1000 Genomes Project cohort including 602 trios. bioRxiv 
2021.02.06.430068.
<a name="18"></a>
18. Layer,R.M., Chiang,C., Quinlan,A.R. and Hall,I.M. (2014) LUMPY: a probabilistic framework
for structural variant discovery. Genome Biol., 15, R84.
<a name="19"></a>
19. Lek,M., Karczewski,K.J., Minikel,E.V., Samocha,K.E., Banks,E., Fennell,T.,
...
<a name="21"></a>
21. Tate,J.G., Bamford,S., Jubb,H.C., Sondka,Z., Beare,D.M., Bindal,N., Boutselakis,H.,
...
<a name="22"></a>
22. 1000 Genomes Project Consortium, Auton,A., Brooks,L.D., Durbin,R.M., Garrison,E.P.,
...
<a name="23"></a>
23. Landrum,M.J., Lee,J.M., Riley,G.R., Jang,W., Rubinstein,W.S., Church,D.M. and
...
<a name="24"></a>
24. Adzhubei,I., Jordan,D.M. and Sunyaev,S.R. (2013) Predicting Functional Effect of Human
Missense Mutations Using PolyPhen-2. Current Protocols in Human Genetics, 76,
7.20.1–7.20.41.
<a name="25"></a>
25. Vaser,R., Adusumalli,S., Leng,S.N., Sikic,M. and Ng,P.C. (2016) SIFT missense predictions
for genomes. Nat. Protoc., 11, 1–9.
<a name="26"></a>
26. Shihab,H.A., Gough,J., Mort,M., Cooper,D.N., Day,I.N.M. and Gaunt,T.R. (2014) Ranking
non-synonymous single nucleotide polymorphisms based on disease concepts. Hum.
Genomics, 8, 11.
<a name="27"></a>
27. Sherry,S.T., Ward,M.H., Kholodov,M., Baker,J., Phan,L., Smigielski,E.M. and Sirotkin,K.
(2001) dbSNP: the NCBI database of genetic variation. Nucleic Acids Res., 29, 308–311.
<a name="28"></a>
28. Kautto,E.A., Bonneville,R., Miya,J., Yu,L., Krook,M.A., Reeser,J.W. and Roychowdhury,S.
...
<a name="29"></a>
29. Lee,H. and Kingsford,C. (2018) Kourami: graph-guided assembly for novel human leukocyte
