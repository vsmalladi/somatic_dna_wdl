...
consists of MuTect2 (GATK 4.0.5.1) ([5](#5))), Strelka2 (2.9.3) ([6](#6)) and Lancet (1.0.7) ([7](#7))] for calling
Single Nucleotide Variants (SNVs) and short Insertion-or-Deletion (Indels), SvABA (0.2.1) ([8](#8))
for calling Indels and Structural variants (SVs), both Manta (1.4.0) ([9](#9)) and GRIDSS (2.12.0) ([10](#10), [11](#11)) for
calling SVs and BIC-Seq2 (0.2.6) ([12](#12)) for calling Copy-number variants (CNVs). Manta also
...
merged across callers using bedtools ([13](#13)) pairtopair (slop of 300bp, same strand orientation,
...
For SVs, we used the resequenced 1000G individuals ([24](#24), [X](#X)) as the basis for the new SV PON.
...
LUMPY (0.2.13) ([2X](#2X)), and SvABA (1.1.3). Of these four callers, GRIDSS, Manta, and Svaba are used 
...
Germ line SNVs and INDELs are annotated with Ensembl Variant Effect Predictor (v97) as well as databases such as COSMIC (v92)
([12](#12)), 1000Genomes (Phase3) ([13](#13)) , ClinVar (201904) ([14](#14)), Polyphen2 (v2.2.2) ([15](#15)), SIFT (v5.2.2) 
([16](#16)), FATHMM (v2.1) ([17](#17)), gnomAD (r2.0.2) ([18](#18)) and dbSNP (v150) ([19](#19)) using Variant Effect Predictor (v93.2) ([20](#20)).
...
<a name="10"></a>
10. Cameron,D.L., Schröder,J., Penington,J.S., Do,H., Molania,R., Dobrovic,A., Speed,T.P., Papenfuss,A.T. (2017)
GRIDSS: sensitive and specific genomic rearrangement detection using positional de Bruijn graph assembly. 
Genome Research, 27(12):2050-2060.
<a name="11"></a>
11. Cameron,D.L., Baber,J., Shale,C., Valle-Inclan,J.E., Besselink,N., van Hoeck,A., Janssen.R.,
...
<a name="12"></a>
12. Xi,R., Lee,S., Xia,Y., Kim,T.-M. and Park,P.J. (2016) Copy number analysis of
...
<a name="13"></a>
13. Quinlan,A.R. and Hall,I.M. (2010) BEDTools: a flexible suite of utilities for comparing
genomic features. Bioinformatics, 26, 841–842.
<a name="14"></a>
14. Tate,J.G., Bamford,S., Jubb,H.C., Sondka,Z., Beare,D.M., Bindal,N., Boutselakis,H.,
...
<a name="15"></a>
15. 1000 Genomes Project Consortium, Auton,A., Brooks,L.D., Durbin,R.M., Garrison,E.P.,
...
<a name="16"></a>
16. Landrum,M.J., Lee,J.M., Riley,G.R., Jang,W., Rubinstein,W.S., Church,D.M. and
...
<a name="17"></a>
17. Adzhubei,I., Jordan,D.M. and Sunyaev,S.R. (2013) Predicting Functional Effect of Human
Missense Mutations Using PolyPhen-2. Current Protocols in Human Genetics, 76,
7.20.1–7.20.41.
<a name="18"></a>
18. Vaser,R., Adusumalli,S., Leng,S.N., Sikic,M. and Ng,P.C. (2016) SIFT missense predictions
for genomes. Nat. Protoc., 11, 1–9.
<a name="19"></a>
19. Shihab,H.A., Gough,J., Mort,M., Cooper,D.N., Day,I.N.M. and Gaunt,T.R. (2014) Ranking
non-synonymous single nucleotide polymorphisms based on disease concepts. Hum.
Genomics, 8, 11.
<a name="20"></a>
20. Lek,M., Karczewski,K.J., Minikel,E.V., Samocha,K.E., Banks,E., Fennell,T.,
...
<a name="21"></a>
21. Sherry,S.T., Ward,M.H., Kholodov,M., Baker,J., Phan,L., Smigielski,E.M. and Sirotkin,K.
(2001) dbSNP: the NCBI database of genetic variation. Nucleic Acids Res., 29, 308–311.
<a name="22"></a>
22. McLaren,W., Gil,L., Hunt,S.E., Riat,H.S., Ritchie,G.R.S., Thormann,A., Flicek,P. and
Cunningham,F. (2016) The Ensembl Variant Effect Predictor. Genome Biol., 17, 122.
<a name="23"></a>
23. MacDonald,J.R., Ziman,R., Yuen,R.K.C., Feuk,L. and Scherer,S.W. (2014) The Database of
Genomic Variants: a curated collection of structural variation in the human genome. Nucleic
Acids Res., 42, D986–92.
<a name="24"></a>
24. Hubbard,T. (2002) The Ensembl genome database project. Nucleic Acids Research, 30,
38–41.
<a name="X"></a>
X. Byrska-Bishop,M., Evani,U.S., Zhao,X., Basile,A.O., Abel,H.J., Regier,A.A., Corvelo,A., Clarke,W.E., 
